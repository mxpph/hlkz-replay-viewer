...
}`;class St{constructor(t){f(this,"program");f(this,"aPosition");f(this,"aTexCoord");f(this,"aTexCoord2");f(this,"uModelMx");f(this,"uViewMx");f(this,"uProjectionMx");f(this,"uDiffuse");f(this,"uLightmap");f(this,"uOpacity");this.program=t.handle,this.aPosition=t.attributes.position,this.aTexCoord=t.attributes.texCoord,this.aTexCoord2=t.attributes.texCoord2,this.uModelMx=t.uniforms.modelMatrix,this.uViewMx=t.uniforms.viewMatrix,this.uProjectionMx=t.uniforms.projectionMatrix,this.uDiffuse=t.uniforms.diffuse,this.uLightmap=t.uniforms.lightmap,this.uOpacity=t.uniforms.opacity}static init(t){const s=["position","texCoord","texCoord2"],n=["modelMatrix","viewMatrix","projectionMatrix","diffuse","lightmap","opacity"],i=t.createProgram({vertexShaderSrc:on,fragmentShaderSrc:rn,attributeNames:s,uniformNames:n});return i?new St(i):(console.error("Failed to create MainShader program"),null)}useProgram(t){t.useProgram(this.program)}setModelMatrix(t,s){t.uniformMatrix4fv(this.uModelMx,!1,s)}setViewMatrix(t,s){t.uniformMatrix4fv(this.uViewMx,!1,s)}setProjectionMatrix(t,s){t.uniformMatrix4fv(this.uProjectionMx,!1,s)}setDiffuse(t,s){t.uniform1i(this.uDiffuse,s)}setLightmap(t,s){t.uniform1i(this.uLightmap,s)}setOpacity(t,s){t.uniform1f(this.uOpacity,s)}enableVertexAttribs(t){t.enableVertexAttribArray(this.aPosition),t.enableVertexAttribArray(this.aTexCoord),t.enableVertexAttribArray(this.aTexCoord2)}setVertexAttribPointers(t){t.vertexAttribPointer(this.aPosition,3,t.FLOAT,!1,7*4,0),t.vertexAttribPointer(this.aTexCoord,2,t.FLOAT,!1,7*4,3*4),t.vertexAttribPointer(this.aTexCoord2,2,t.FLOAT,!1,7*4,5*4)}}var R=(e=>(e[e.Normal=0]="Normal",e[e.Color=1]="Color",e[e.Texture=2]="Texture",e[e.Glow=3]="Glow",e[e.Solid=4]="Solid",e[e.Additive=5]="Additive",e))(R||{});const ts=(e,t,s,n,i)=>{const r=document.createElement("canvas"),a=r.getContext("2d");if(!a)throw new Error("Runtime error.");r.width=t,r.height=s;const o=document.createElement("canvas"),l=o.getContext("2d");if(!l)throw new Error("Runtime error.");o.width=n,o.height=i;const c=a.createImageData(t,s);for(let u=0,h=t*s*4;u<h;u+=4)c.data[u]=e[u],c.data[u+1]=e[u+1],c.data[u+2]=e[u+2],c.data[u+3]=e[u+3];return a.putImageData(c,0,0),l.drawImage(r,0,0,n,i),new Uint8Array(l.getImageData(0,0,n,i).data)},qe=e=>(e&e-1)===0,Ve=e=>{let t=e;--t;for(let s=1;s<32;s<<=1)t=t|t>>s;return t+1};class Nt{constructor(t){f(this,"buffer");f(this,"context");f(this,"shader");f(this,"modelMatrix",At());f(this,"sceneInfo",{length:0,data:new Float32Array(0),models:[]});f(this,"bsp",null);f(this,"textures",[]);f(this,"sprites",{});f(this,"lightmap",null);this.buffer=t.buffer,this.context=t.context,this.shader=t.shader}static init(t){const s=St.init(t);if(!s)return console.error("Failed to init MainShader"),null;s.useProgram(t.gl);const n=t.gl.createBuffer();return n?new Nt({buffer:n,context:t,shader:s}):(console.error("Failed to create WebGL buffer"),null)}changeMap(t){this.fillBuffer(t),this.loadTextures(t),this.loadSpriteTextures(t),this.loadLightmap(t),this.bsp=t}fillBuffer(t){const s=this.context.gl,n=t.models,i=["aaatrigger","clip","null","hint","nodraw","invisible","skip","trigger","sky","fog"];let r=0;for(let c=0;c<n.length;++c){const u=n[c];for(let h=0;h<u.faces.length;++h){const g=t.textures[u.faces[h].textureIndex];i.indexOf(g.name)>-1||(r+=u.faces[h].buffer.length)}}r+=7*6;const a={length:r,data:new Float32Array(r),models:[]};let o=0;for(let c=0;c<t.models.length;++c){const u=t.models[c],h={origin:u.origin,offset:o,length:0,isTransparent:!1,faces:[]};for(let g=0;g<u.faces.length;++g){const d=t.textures[u.faces[g].textureIndex];if(i.indexOf(d.name)>-1)continue;const m={offset:o,length:0,textureIndex:-1};for(let p=0;p<u.faces[g].buffer.length;++p)a.data[o++]=u.faces[g].buffer[p];!h.isTransparent&&t.textures[u.faces[g].textureIndex].name[0]==="{"&&(h.isTransparent=!0),m.textureIndex=u.faces[g].textureIndex,m.length=o-m.offset,h.faces.push(m)}h.length=o-h.offset,a.models.push(h)}a.models.push({origin:[0,0,0],offset:o,length:4,isTransparent:!1,faces:[{offset:o,length:4,textureIndex:0}]}),a.data[o++]=-.5,a.data[o++]=0,a.data[o++]=-.5,a.data[o++]=1,a.data[o++]=1,a.data[o++]=0,a.data[o++]=0,a.data[o++]=.5,a.data[o++]=0,a.data[o++]=.5,a.data[o++]=0,a.data[o++]=0,a.data[o++]=0,a.data[o++]=0,a.data[o++]=-.5,a.data[o++]=0,a.data[o++]=.5,a.data[o++]=1,a.data[o++]=0,a.data[o++]=0,a.data[o++]=0,a.data[o++]=-.5,a.data[o++]=0,a.data[o++]=-.5,a.data[o++]=1,a.data[o++]=1,a.data[o++]=0,a.data[o++]=0,a.data[o++]=.5,a.data[o++]=0,a.data[o++]=-.5,a.data[o++]=0,a.data[o++]=1,a.data[o++]=0,a.data[o++]=0,a.data[o++]=.5,a.data[o++]=0,a.data[o++]=.5,a.data[o++]=0,a.data[o++]=0,a.data[o++]=0,a.data[o++]=0,o=0;const l={data:new Float32Array(a.data),length:a.length,models:a.models.map(c=>({origin:Us(c.origin),offset:c.offset,length:c.length,isTransparent:c.isTransparent,faces:c.faces.map(u=>({offset:u.offset,length:u.length,textureIndex:u.textureIndex}))}))};for(let c=0;c<l.models.length;++c){const u=l.models[c];u.faces.sort((d,m)=>d.textureIndex-m.textureIndex);for(let d=0;d<u.faces.length;++d){const m=u.faces[d],p=o;for(let E=0;E<m.length;++E)l.data[o]=a.data[m.offset+E],o+=1;m.offset=p}const h=[];let g=-1;for(let d=0;d<u.faces.length;++d){const m=u.faces[d];m.textureIndex===g?h[h.length-1].length+=m.length:(h.push({offset:m.offset,length:m.length,textureIndex:m.textureIndex}),g=m.textureIndex)}u.faces=h}this.sceneInfo=l,s.bindBuffer(s.ARRAY_BUFFER,this.buffer),s.bufferData(s.ARRAY_BUFFER,this.sceneInfo.data,s.STATIC_DRAW)}loadTextures(t){const s=this.context.gl;for(let n=0;n<t.textures.length;++n){const i=s.createTexture();if(!i)throw new Error("fatal error");const r=t.textures[n];if(!qe(r.width)||!qe(r.height)){const o=r.width,l=r.height,c=Ve(r.width),u=Ve(r.height);r.data=ts(r.data,o,l,c,u),r.width=c,r.height=u}s.bindTexture(s.TEXTURE_2D,i),s.texImage2D(s.TEXTURE_2D,0,s.RGBA,r.width,r.height,0,s.RGBA,s.UNSIGNED_BYTE,r.data),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MAG_FILTER,s.LINEAR),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MIN_FILTER,s.LINEAR_MIPMAP_LINEAR),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_S,s.REPEAT),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_T,s.REPEAT),s.generateMipmap(s.TEXTURE_2D);const a=this.context.getAnisotropyExtension();a&&s.texParameteri(s.TEXTURE_2D,a.TEXTURE_MAX_ANISOTROPY_EXT,this.context.getMaxAnisotropy(a)),this.textures.push({name:r.name,width:r.width,height:r.height,data:r.data,handle:i})}}loadSpriteTextures(t){const s=this.context.gl;for(const[n,i]of Object.entries(t.sprites)){const r=s.createTexture();if(!r)throw new Error("fatal error");const a=i.frames[0];if(!qe(a.width)||!qe(a.height)){const l=a.width,c=a.height,u=Ve(a.width),h=Ve(a.height);a.data=ts(a.data,l,c,u,h),a.width=u,a.height=h}s.bindTexture(s.TEXTURE_2D,r),s.texImage2D(s.TEXTURE_2D,0,s.RGBA,a.width,a.height,0,s.RGBA,s.UNSIGNED_BYTE,a.data),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MAG_FILTER,s.LINEAR),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MIN_FILTER,s.LINEAR_MIPMAP_LINEAR),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_S,s.REPEAT),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_T,s.REPEAT),s.generateMipmap(s.TEXTURE_2D);const o=this.context.getAnisotropyExtension();o&&s.texParameteri(s.TEXTURE_2D,o.TEXTURE_MAX_ANISOTROPY_EXT,this.context.getMaxAnisotropy(o)),this.textures.push({name:n,width:a.width,height:a.height,data:a.data,handle:r}),this.sprites[n]=i}}loadLightmap(t){const s=this.context.gl,n=s.createTexture();if(!n)throw new Error("fatal error");s.bindTexture(s.TEXTURE_2D,n),s.texImage2D(s.TEXTURE_2D,0,s.RGBA,t.lightmap.width,t.lightmap.height,0,s.RGBA,s.UNSIGNED_BYTE,t.lightmap.data),s.generateMipmap(s.TEXTURE_2D),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MAG_FILTER,s.LINEAR),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MIN_FILTER,s.LINEAR_MIPMAP_LINEAR),this.lightmap={data:t.lightmap.data,handle:n}}draw(t,s){if(!this.bsp||!this.lightmap)return;const n=this.context.gl,i=this.shader;i.useProgram(n),t.updateProjectionMatrix(),t.updateViewMatrix(),i.setViewMatrix(n,t.viewMatrix),i.setProjectionMatrix(n,t.projectionMatrix),n.bindBuffer(n.ARRAY_BUFFER,this.buffer),i.enableVertexAttribs(n),i.setVertexAttribPointers(n),i.setDiffuse(n,0),i.setLightmap(n,1),n.activeTexture(n.TEXTURE1),n.bindTexture(n.TEXTURE_2D,this.lightmap.handle),n.activeTexture(n.TEXTURE0);const r=s.filter(l=>!l.classname.startsWith("trigger_")),a=[],o=[];for(const l of r)if(l.model)if(!l.rendermode||l.rendermode===R.Normal||l.rendermode===R.Solid){if(l.model[0]==="*"){if(this.sceneInfo.models[Number.parseInt(l.model.substr(1))].isTransparent){o.push(l);continue}}else if(l.model.indexOf(".spr")>-1){o.push(l);continue}a.push(l)}else l.rendermode,R.Additive,o.push(l);i.setOpacity(n,1),this.renderWorldSpawn(),this.renderOpaqueEntities(t,a),o.length&&(n.depthMask(!1),this.renderTransparentEntities(o,t),n.depthMask(!0))}renderWorldSpawn(){const t=this.sceneInfo.models[0],s=this.context.gl;ke(this.modelMatrix),this.shader.setModelMatrix(s,this.modelMatrix);for(let n=0;n<t.faces.length;++n){const i=t.faces[n];s.bindTexture(s.TEXTURE_2D,this.textures[i.textureIndex].handle),s.drawArrays(s.TRIANGLES,i.offset/7,i.length/7)}}renderOpaqueEntities(t,s){const n=this.context.gl,i=this.shader,r=this.modelMatrix;for(let a=0;a<s.length;++a){const o=s[a],l=Number.parseInt(o.model.substr(1)),c=this.sceneInfo.models[l];if(c){const u=o.origin?oe(o.origin[0],o.origin[1],o.origin[2]):ge();Fs(u,u,c.origin),ke(r),Pe(r,r,u),i.setModelMatrix(n,r);for(let h=0;h<c.faces.length;++h){const g=c.faces[h];n.bindTexture(n.TEXTURE_2D,this.textures[g.textureIndex].handle),n.drawArrays(n.TRIANGLES,g.offset/7,g.length/7)}}else if(o.model.indexOf(".spr")>-1){const u=this.textures.find(g=>g.name===o.model),h=this.sprites[o.model];if(u&&h){const g=o.origin?oe(o.origin[0],o.origin[1],o.origin[2]):ge(),d=oe(u.width,1,u.height),m=o.angles?oe(o.angles[0],o.angles[2],o.angles[1]):ge();switch(Qt(d,d,o.scale||1),ke(r),Pe(r,r,g),h.header.type){case J.VP_PARALLEL_UPRIGHT:{Q(r,r,t.rotation[1]+Math.PI/2);break}case J.FACING_UPRIGHT:{Q(r,r,t.rotation[1]+Math.PI/2);break}case J.VP_PARALLEL:{Q(r,r,Math.atan2(g[1]-t.position[1],g[0]-t.position[0])+Math.PI/2),Se(r,r,Math.atan2(t.position[2]-g[2],Math.sqrt((t.position[0]-g[0])**2+(t.position[1]-g[1])**2)));break}case J.ORIENTED:{We(r,r,m[0]*Math.PI/180+Math.PI),Q(r,r,m[1]*Math.PI/180+Math.PI),Se(r,r,m[2]*Math.PI/180-Math.PI/2);break}case J.VP_PARALLEL_ORIENTED:{We(r,r,m[0]*Math.PI/180+Math.PI),Q(r,r,m[1]*Math.PI/180+Math.PI);break}default:throw new Error("Invalid sprite type")}switch(Jt(r,r,d),i.setModelMatrix(n,r),i.setOpacity(n,(o.renderamt||255)/255),o.rendermode||R.Normal){case R.Normal:{i.setOpacity(n,1),n.bindTexture(n.TEXTURE_2D,u.handle),n.drawArrays(n.TRIANGLES,this.sceneInfo.models[this.sceneInfo.models.length-1].offset/7,6);break}case R.Color:{i.setOpacity(n,(o.renderamt||255)/255),n.bindTexture(n.TEXTURE_2D,u.handle),n.drawArrays(n.TRIANGLES,this.sceneInfo.models[this.sceneInfo.models.length-1].offset/7,6);break}case R.Texture:{i.setOpacity(n,(o.renderamt||255)/255),n.bindTexture(n.TEXTURE_2D,u.handle),n.drawArrays(n.TRIANGLES,this.sceneInfo.models[this.sceneInfo.models.length-1].offset/7,6);break}case R.Glow:{n.blendFunc(n.SRC_ALPHA,n.DST_ALPHA),i.setOpacity(n,(o.renderamt||255)/255),n.bindTexture(n.TEXTURE_2D,u.handle),n.drawArrays(n.TRIANGLES,this.sceneInfo.models[this.sceneInfo.models.length-1].offset/7,6),n.blendFunc(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA);break}case R.Solid:{i.setOpacity(n,(o.renderamt||255)/255),n.bindTexture(n.TEXTURE_2D,u.handle),n.drawArrays(n.TRIANGLES,this.sceneInfo.models[this.sceneInfo.models.length-1].offset/7,6);break}case R.Additive:{n.blendFunc(n.SRC_ALPHA,n.DST_ALPHA),i.setOpacity(n,(o.renderamt||255)/255),n.bindTexture(n.TEXTURE_2D,u.handle),n.drawArrays(n.TRIANGLES,this.sceneInfo.models[this.sceneInfo.models.length-1].offset/7,6),n.blendFunc(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA);break}}}}}}renderTransparentEntities(t,s){const n=this.context.gl,i=this.shader,r=this.modelMatrix,a=t.map((o,l)=>({index:l,distance:$s(s.position,o.origin||[0,0,0])})).sort((o,l)=>o.distance-l.distance);for(let o=0;o<a.length;++o){const l=t[a[o].index],c=Number.parseInt(l.model.substr(1)),u=this.sceneInfo.models[c];if(u){const h=l.origin||[0,0,0];switch(h[0]+=u.origin[0],h[1]+=u.origin[1],h[2]+=u.origin[2],ke(r),Pe(r,r,h),i.setModelMatrix(n,r),l.rendermode||R.Normal){case R.Normal:{i.setOpacity(n,1);for(let d=0;d<u.faces.length;++d){const m=u.faces[d];n.bindTexture(n.TEXTURE_2D,this.textures[m.textureIndex].handle),n.drawArrays(n.TRIANGLES,m.offset/7,m.length/7)}break}case R.Color:{i.setOpacity(n,(l.renderamt||255)/255);for(let d=0;d<u.faces.length;++d){const m=u.faces[d];n.bindTexture(n.TEXTURE_2D,this.textures[m.textureIndex].handle),n.drawArrays(n.TRIANGLES,m.offset/7,m.length/7)}break}case R.Texture:{i.setOpacity(n,(l.renderamt||255)/255);for(let d=0;d<u.faces.length;++d){const m=u.faces[d];n.bindTexture(n.TEXTURE_2D,this.textures[m.textureIndex].handle),n.drawArrays(n.TRIANGLES,m.offset/7,m.length/7)}break}case R.Glow:{i.setOpacity(n,(l.renderamt||255)/255);for(let d=0;d<u.faces.length;++d){const m=u.faces[d];n.bindTexture(n.TEXTURE_2D,this.textures[m.textureIndex].handle),n.drawArrays(n.TRIANGLES,m.offset/7,m.length/7)}break}case R.Solid:{i.setOpacity(n,(l.renderamt||255)/255);for(let d=0;d<u.faces.length;++d){const m=u.faces[d];n.bindTexture(n.TEXTURE_2D,this.textures[m.textureIndex].handle),n.drawArrays(n.TRIANGLES,m.offset/7,m.length/7)}break}case R.Additive:{n.blendFunc(n.SRC_ALPHA,n.DST_ALPHA),i.setOpacity(n,(l.renderamt||255)/255);for(let d=0;d<u.faces.length;++d){const m=u.faces[d];n.bindTexture(n.TEXTURE_2D,this.textures[m.textureIndex].handle),n.drawArrays(n.TRIANGLES,m.offset/7,m.length/7)}n.blendFunc(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA);break}}}else if(l.model.indexOf(".spr")>-1){const h=this.textures.find(d=>d.name===l.model),g=this.sprites[l.model];if(h&&g){const d=l.origin?oe(l.origin[0],l.origin[1],l.origin[2]):ge(),m=oe(h.width,1,h.height),p=l.angles?oe(l.angles[0],l.angles[2],l.angles[1]):ge();switch(Qt(m,m,l.scale||1),ke(r),Pe(r,r,d),g.header.type){case J.VP_PARALLEL_UPRIGHT:{Q(r,r,s.rotation[1]+Math.PI/2);break}case J.FACING_UPRIGHT:{Q(r,r,s.rotation[1]+Math.PI/2);break}case J.VP_PARALLEL:{Q(r,r,Math.atan2(d[1]-s.position[1],d[0]-s.position[0])+Math.PI/2),Se(r,r,Math.atan2(s.position[2]-d[2],Math.sqrt((s.position[0]-d[0])**2+(s.position[1]-d[1])**2)));break}case J.ORIENTED:{We(r,r,p[0]*Math.PI/180+Math.PI),Q(r,r,p[1]*Math.PI/180+Math.PI),Se(r,r,p[2]*Math.PI/180-Math.PI/2);break}case J.VP_PARALLEL_ORIENTED:{We(r,r,p[0]*Math.PI/180+Math.PI),Q(r,r,p[1]*Math.PI/180+Math.PI);break}default:throw new Error("Invalid sprite type")}switch(Jt(r,r,m),i.setModelMatrix(n,r),i.setOpacity(n,(l.renderamt||255)/255),l.rendermode||R.Normal){case R.Normal:{i.setOpacity(n,1),n.bindTexture(n.TEXTURE_2D,h.handle),n.drawArrays(n.TRIANGLES,this.sceneInfo.models[this.sceneInfo.models.length-1].offset/7,6);break}case R.Color:{i.setOpacity(n,(l.renderamt||255)/255),n.bindTexture(n.TEXTURE_2D,h.handle),n.drawArrays(n.TRIANGLES,this.sceneInfo.models[this.sceneInfo.models.length-1].offset/7,6);break}case R.Texture:{i.setOpacity(n,(l.renderamt||255)/255),n.bindTexture(n.TEXTURE_2D,h.handle),n.drawArrays(n.TRIANGLES,this.sceneInfo.models[this.sceneInfo.models.length-1].offset/7,6);break}case R.Glow:{n.blendFunc(n.SRC_ALPHA,n.DST_ALPHA),i.setOpacity(n,(l.renderamt||255)/255),n.bindTexture(n.TEXTURE_2D,h.handle),n.drawArrays(n.TRIANGLES,this.sceneInfo.models[this.sceneInfo.models.length-1].offset/7,6),n.blendFunc(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA);break}case R.Solid:{i.setOpacity(n,(l.renderamt||255)/255),n.bindTexture(n.TEXTURE_2D,h.handle),n.drawArrays(n.TRIANGLES,this.sceneInfo.models[this.sceneInfo.models.length-1].offset/7,6);break}case R.Additive:{n.blendFunc(n.SRC_ALPHA,n.DST_ALPHA),i.setOpacity(n,(l.renderamt||255)/255),n.bindTexture(n.TEXTURE_2D,h.handle),n.drawArrays(n.TRIANGLES,this.sceneInfo.models[this.sceneInfo.models.length-1].offset/7,6),n.blendFunc(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA);break}}}}}}}var W=(e=>(e[e.FREE=0]="FREE",e[e.REPLAY=1]="REPLAY",e))(W||{});class Ot{constructor(t){f(this,"config");f(this,"pauseTime",0);f(this,"isPaused",!1);f(this,"lastTime",0);f(this,"accumTime",0);f(this,"timeStep",1/60);f(this,"title","");f(this,"mode");f(this,"pointerLocked",!1);f(this,"showKeys",!0);f(this,"touch",new en);f(this,"mouse",new Qs);f(this,"keyboard",new ae);f(this,"loader");f(this,"entities",[]);f(this,"sounds");f(this,"soundSystem");f(this,"events");f(this,"player");f(this,"canvas");f(this,"mapName");f(this,"context");f(this,"camera");f(this,"renderer");f(this,"worldScene");f(this,"skyScene");f(this,"onLoadAll",t=>{if(t!=null&&t.replay&&(this.changeReplay(t.replay.data,t.replayType),this.changeMode(1)),!t.map||!t.map.data)return;const s=t.map.data,n=t.skies;let i=!0;for(const r of n)i=i&&r.isDone();if(i)for(const r of n)r.data&&s.skies.push(r.data);for(const[r,a]of Object.entries(t.sprites))a.data&&(s.sprites[r]=a.data);if(t.sounds.length>0)for(const r of t.sounds)r.data&&this.sounds.push(r.data);this.changeMap(s),this.events.emit("load",t)});f(this,"draw",()=>{requestAnimationFrame(this.draw);const t=this.canvas,s=t.parentElement;if(s){const r=s.clientWidth,a=s.clientHeight;(t.width!==r||t.height!==a)&&(t.width=r,t.height=a,this.camera.aspect=t.clientWidth/t.clientHeight,this.camera.updateProjectionMatrix(),this.context.gl.viewport(0,0,this.context.gl.drawingBufferWidth,this.context.gl.drawingBufferHeight)),(t.clientWidth!==t.width||t.clientHeight!==t.height)&&(t.width=t.clientWidth,t.height=t.clientHeight,this.camera.aspect=t.clientWidth/t.clientHeight,this.camera.updateProjectionMatrix(),this.context.gl.viewport(0,0,this.context.gl.drawingBufferWidth,this.context.gl.drawingBufferHeight))}if(this.isPaused)return;const n=fe()/1e3,i=n-this.lastTime;for(this.accumTime+=i;this.accumTime>this.timeStep;)this.update(this.timeStep),this.accumTime-=this.timeStep;this.renderer.draw(),this.mapName!==""&&(this.skyScene.draw(this.camera),this.worldScene.draw(this.camera,this.entities)),this.lastTime=n});f(this,"onTouchStart",t=>{const s=t.touches.item(0);s&&(this.touch.pressed=!0,this.touch.position[0]=s.clientX,this.touch.position[1]=s.clientY)});f(this,"onTouchEnd",()=>{this.touch.pressed=!1,this.touch.delta[0]=0,this.touch.delta[1]=0});f(this,"onTouchMove",t=>{const s=t.touches.item(0);s&&this.touch.pressed&&(this.touch.delta[0],this.touch.delta[0]=s.clientX-this.touch.position[0],this.touch.delta[1]=s.clientY-this.touch.position[1],this.touch.position[0]=s.clientX,this.touch.position[1]=s.clientY)});f(this,"onMouseMove",t=>{this.pointerLocked&&(this.mouse.delta[0]=t.movementX,this.mouse.delta[1]=t.movementY,this.mouse.position[0]=t.pageX,this.mouse.position[1]=t.pageY)});f(this,"keyDown",t=>(this.keyboard.keys[t.which]=1,this.pointerLocked?(t.preventDefault(),!1):!0));f(this,"keyUp",t=>(this.keyboard.keys[t.which]=0,this.pointerLocked?(t.preventDefault(),!1):!0));f(this,"onVisibilityChange",()=>{if(document.hidden){if(this.isPaused)return;this.pauseTime=fe()/1e3,this.isPaused=!0}else{if(!this.isPaused)return;this.lastTime=fe()/1e3-this.pauseTime+this.lastTime,this.isPaused=!1}});this.sounds=[],this.soundSystem=new zt,this.config=t.config,this.loader=new Js(this.config),this.loader.events.on("loadall",this.onLoadAll),document.addEventListener("touchstart",this.onTouchStart,!1),document.addEventListener("touchend",this.onTouchEnd,!1),document.addEventListener("touchcancel",this.onTouchEnd,!1),document.addEventListener("touchmove",this.onTouchMove,!1),document.addEventListener("mousemove",this.onMouseMove,!1),window.addEventListener("keydown",this.keyDown),window.addEventListener("keyup",this.keyUp),window.addEventListener("visibilitychange",this.onVisibilityChange),this.canvas=t.canvas,this.camera=_t.init(this.canvas.width/this.canvas.height),this.context=t.context,this.renderer=t.renderer,this.worldScene=t.worldScene,this.skyScene=t.skyScene,this.mode=0,this.player=new tn(this),this.events=G(),this.mapName=""}static init(t){if(!ze.checkWebGLSupport().hasSupport)return{status:"error",message:"No WebGL support!"};const n=document.createElement("canvas");if(!n)return{status:"error",message:"Failed to create <canvas> element!"};const i=ze.init(n);if(!i)return{status:"error",message:"Failed to initialize WebGL context"};const r=Rt.init(i);if(!r)return{status:"error",message:"Failed to initialize renderer"};const a=Nt.init(i);if(!a)return{status:"error",message:"Failed to initialize world scene"};const o=Pt.init(i);return o?{status:"success",game:new Ot({canvas:n,config:t,context:i,renderer:r,worldScene:a,skyScene:o})}:{status:"error",message:"Failed to initialize sky scene"}}getCanvas(){return this.canvas}load(t){this.events.emit("loadstart"),this.loader.load(t)}changeMap(t){if(this.mapName.toLowerCase()===t.name.toLowerCase())return;this.mapName=t.name,this.worldScene.changeMap(t),this.skyScene.changeMap(t),this.entities=t.entities;const s=t.entities.find(n=>n.classname==="info_player_start");s?(this.camera.position[0]=s.origin[0],this.camera.position[1]=s.origin[1],this.camera.position[2]=s.origin[2]):(this.camera.position[0]=0,this.camera.position[1]=0,this.camera.position[2]=0),this.camera.rotation[0]=0,this.camera.rotation[1]=0,this.camera.rotation[2]=0}changeReplay(t,s){this.events.emit("prereplaychange",this,t),this.player.changeReplay(t,s),this.events.emit("postreplaychange",this,t)}changeMode(t){this.mode=t,this.events.emit("modechange",t)}setTitle(t){this.title=t,this.events.emit("titlechange",t)}getTitle(){return this.title}changeShowKeys(){this.showKeys=!this.showKeys,this.events.emit("showkeyschange",this.showKeys)}update(t){this.events.emit("preupdate",this);const s=this.camera,n=this.keyboard,i=this.mouse,r=this.touch;if(this.mode===1)this.player.update(t);else if(this.mode===0){this.touch.pressed?(s.rotation[0]=Math.min(Math.max(s.rotation[0]+r.delta[1]/100,-Math.PI/2),Math.PI/2),s.rotation[1]-=r.delta[0]/100):(s.rotation[0]=Math.min(Math.max(s.rotation[0]+i.delta[1]/100,-Math.PI/2),Math.PI/2),s.rotation[1]-=i.delta[0]/100);const o=500*t,l=ae.KEYS.W,c=ae.KEYS.S,u=ae.KEYS.A,h=ae.KEYS.D,g=ae.KEYS.C,d=ae.KEYS.SPACE;if(n.keys[l]!==n.keys[c]){const m=s.rotation[1],p=s.rotation[0];n.keys[l]?(s.position[0]+=Math.cos(m)*Math.cos(p)*o,s.position[1]+=Math.sin(m)*Math.cos(p)*o,s.position[2]-=Math.sin(p)*o):n.keys[c]&&(s.position[0]-=Math.cos(m)*Math.cos(p)*o,s.position[1]-=Math.sin(m)*Math.cos(p)*o,s.position[2]+=Math.sin(p)*o)}n.keys[u]!==n.keys[h]&&(n.keys[u]?(s.position[1]+=Math.cos(s.rotation[1])*o,s.position[0]-=Math.sin(s.rotation[1])*o):n.keys[h]&&(s.position[1]-=Math.cos(s.rotation[1])*o,s.position[0]+=Math.sin(s.rotation[1])*o)),n.keys[d]!==n.keys[g]&&(n.keys[d]?s.position[2]+=o:n.keys[g]&&(s.position[2]-=o))}i.delta[0]=0,i.delta[1]=0,this.events.emit("postupdate",this)}}class Ze{constructor(t){f(this,"paths");this.paths={...t.paths}}static init(t){var s,n,i,r,a,o;return typeof t=="string"?new Ze({paths:{base:t,replays:`${t}/replays`,maps:`${t}/maps`,wads:`${t}/wads`,skies:`${t}/skies`,sounds:`${t}/sounds`}}):new Ze({paths:{base:((s=t==null?void 0:t.paths)==null?void 0:s.base)||"",replays:((n=t==null?void 0:t.paths)==null?void 0:n.replays)||"/replays",maps:((i=t==null?void 0:t.paths)==null?void 0:i.maps)||"/maps",wads:((r=t==null?void 0:t.paths)==null?void 0:r.wads)||"/wads",skies:((a=t==null?void 0:t.paths)==null?void 0:a.skies)||"/skies",sounds:((o=t==null?void 0:t.paths)==null?void 0:o.sounds)||"/sounds"}})}getBasePath(){return this.paths.base}getReplaysPath(){return this.paths.replays}getMapsPath(){return this.paths.maps}getWadsPath(){return this.paths.wads}getSkiesPath(){return this.paths.skies}getSoundsPath(){return this.paths.sounds}}const an=!1,ln=(e,t)=>e===t,we=Symbol("solid-proxy"),Dt=Symbol("solid-track"),Ke={equals:ln};let ss=os;const pe=1,Ye=2,ns={owned:null,cleanups:null,context:null,owner:null};var P=null;let Bt=null,cn=null,D=null,H=null,le=null,Je=0;function Qe(e,t){const s=D,n=P,i=e.length===0,r=t===void 0?n:t,a=i?ns:{owned:null,cleanups:null,context:r?r.context:null,owner:r},o=i?e:()=>e(()=>ce(()=>Ue(a)));P=a,D=null;try{return _e(o,!0)}finally{D=s,P=n}}function V(e,t){t=t?Object.assign({},Ke,t):Ke;const s={value:e,observers:null,observerSlots:null,comparator:t.equals||void 0},n=i=>(typeof i=="function"&&(i=i(s.value)),rs(s,i));return[is.bind(s),n]}function Z(e,t,s){const n=Ft(e,t,!1,pe);Be(n)}function un(e,t,s){ss=En;const n=Ft(e,t,!1,pe);n.user=!0,le?le.push(n):Be(n)}function se(e,t,s){s=s?Object.assign({},Ke,s):Ke;const n=Ft(e,t,!0,0);return n.observers=null,n.observerSlots=null,n.comparator=s.equals||void 0,Be(n),is.bind(n)}function hn(e){return _e(e,!1)}function ce(e){if(D===null)return e();const t=D;D=null;try{return e()}finally{D=t}}function De(e){un(()=>ce(e))}function Ie(e){return P===null||(P.cleanups===null?P.cleanups=[e]:P.cleanups.push(e)),e}function Ut(){return D}function fn(e,t){const s=Symbol("context");return{id:s,Provider:vn(s),defaultValue:e}}function dn(e){let t;return P&&P.context&&(t=P.context[e.id])!==void 0?t:e.defaultValue}function mn(e){const t=se(e),s=se(()=>Ct(t()));return s.toArray=()=>{const n=s();return Array.isArray(n)?n:n!=null?[n]:[]},s}function is(){if(this.sources&&this.state)if(this.state===pe)Be(this);else{const e=H;H=null,_e(()=>tt(this),!1),H=e}if(D){const e=this.observers?this.observers.length:0;D.sources?(D.sources.push(this),D.sourceSlots.push(e)):(D.sources=[this],D.sourceSlots=[e]),this.observers?(this.observers.push(D),this.observerSlots.push(D.sources.length-1)):(this.observers=[D],this.observerSlots=[D.sources.length-1])}return this.value}function rs(e,t,s){let n=e.value;return(!e.comparator||!e.comparator(n,t))&&(e.value=t,e.observers&&e.observers.length&&_e(()=>{for(let i=0;i<e.observers.length;i+=1){const r=e.observers[i],a=Bt&&Bt.running;a&&Bt.disposed.has(r),(a?!r.tState:!r.state)&&(r.pure?H.push(r):le.push(r),r.observers&&as(r)),a||(r.state=pe)}if(H.length>1e6)throw H=[],new Error},!1)),t}function Be(e){if(!e.fn)return;Ue(e);const t=Je;gn(e,e.value,t)}function gn(e,t,s){let n;const i=P,r=D;D=P=e;try{n=e.fn(t)}catch(a){return e.pure&&(e.state=pe,e.owned&&e.owned.forEach(Ue),e.owned=null),e.updatedAt=s+1,ls(a)}finally{D=r,P=i}(!e.updatedAt||e.updatedAt<=s)&&(e.updatedAt!=null&&"observers"in e?rs(e,n):e.value=n,e.updatedAt=s)}function Ft(e,t,s,n=pe,i){const r={fn:e,state:n,updatedAt:null,owned:null,sources:null,sourceSlots:null,cleanups:null,value:t,owner:P,context:P?P.context:null,pure:s};return P===null||P!==ns&&(P.owned?P.owned.push(r):P.owned=[r]),r}function et(e){if(e.state===0)return;if(e.state===Ye)return tt(e);if(e.suspense&&ce(e.suspense.inFallback))return e.suspense.effects.push(e);const t=[e];for(;(e=e.owner)&&(!e.updatedAt||e.updatedAt<Je);)e.state&&t.push(e);for(let s=t.length-1;s>=0;s--)if(e=t[s],e.state===pe)Be(e);else if(e.state===Ye){const n=H;H=null,_e(()=>tt(e,t[0]),!1),H=n}}function _e(e,t){if(H)return e();let s=!1;t||(H=[]),le?s=!0:le=[],Je++;try{const n=e();return pn(s),n}catch(n){s||(le=null),H=null,ls(n)}}function pn(e){if(H&&(os(H),H=null),e)return;const t=le;le=null,t.length&&_e(()=>ss(t),!1)}function os(e){for(let t=0;t<e.length;t++)et(e[t])}function En(e){let t,s=0;for(t=0;t<e.length;t++){const n=e[t];n.user?e[s++]=n:et(n)}for(t=0;t<s;t++)et(e[t])}function tt(e,t){e.state=0;for(let s=0;s<e.sources.length;s+=1){const n=e.sources[s];if(n.sources){const i=n.state;i===pe?n!==t&&(!n.updatedAt||n.updatedAt<Je)&&et(n):i===Ye&&tt(n,t)}}}function as(e){for(let t=0;t<e.observers.length;t+=1){const s=e.observers[t];s.state||(s.state=Ye,s.pure?H.push(s):le.push(s),s.observers&&as(s))}}function Ue(e){let t;if(e.sources)for(;e.sources.length;){const s=e.sources.pop(),n=e.sourceSlots.pop(),i=s.observers;if(i&&i.length){const r=i.pop(),a=s.observerSlots.pop();n<i.length&&(r.sourceSlots[a]=n,i[n]=r,s.observerSlots[n]=a)}}if(e.tOwned){for(t=e.tOwned.length-1;t>=0;t--)Ue(e.tOwned[t]);delete e.tOwned}if(e.owned){for(t=e.owned.length-1;t>=0;t--)Ue(e.owned[t]);e.owned=null}if(e.cleanups){for(t=e.cleanups.length-1;t>=0;t--)e.cleanups[t]();e.cleanups=null}e.state=0}function Tn(e){return e instanceof Error?e:new Error(typeof e=="string"?e:"Unknown error",{cause:e})}function ls(e,t=P){throw Tn(e)}function Ct(e){if(typeof e=="function"&&!e.length)return Ct(e());if(Array.isArray(e)){const t=[];for(let s=0;s<e.length;s++){const n=Ct(e[s]);Array.isArray(n)?t.push.apply(t,n):t.push(n)}return t}return e}function vn(e,t){return function(n){let i;return Z(()=>i=ce(()=>(P.context={...P.context,[e]:n.value},mn(()=>n.children))),void 0),i}}const yn=Symbol("fallback");function cs(e){for(let t=0;t<e.length;t++)e[t]()}function wn(e,t,s={}){let n=[],i=[],r=[],a=0,o=t.length>1?[]:null;return Ie(()=>cs(r)),()=>{let l=e()||[],c=l.length,u,h;return l[Dt],ce(()=>{let d,m,p,E,v,y,x,w,M;if(c===0)a!==0&&(cs(r),r=[],n=[],i=[],a=0,o&&(o=[])),s.fallback&&(n=[yn],i[0]=Qe(C=>(r[0]=C,s.fallback())),a=1);else if(a===0){for(i=new Array(c),h=0;h<c;h++)n[h]=l[h],i[h]=Qe(g);a=c}else{for(p=new Array(c),E=new Array(c),o&&(v=new Array(c)),y=0,x=Math.min(a,c);y<x&&n[y]===l[y];y++);for(x=a-1,w=c-1;x>=y&&w>=y&&n[x]===l[w];x--,w--)p[w]=i[x],E[w]=r[x],o&&(v[w]=o[x]);for(d=new Map,m=new Array(w+1),h=w;h>=y;h--)M=l[h],u=d.get(M),m[h]=u===void 0?-1:u,d.set(M,h);for(u=y;u<=x;u++)M=n[u],h=d.get(M),h!==void 0&&h!==-1?(p[h]=i[u],E[h]=r[u],o&&(v[h]=o[u]),h=m[h],d.set(M,h)):r[u]();for(h=y;h<c;h++)h in p?(i[h]=p[h],r[h]=E[h],o&&(o[h]=v[h],o[h](h))):i[h]=Qe(g);i=i.slice(0,a=c),n=l.slice(0)}return i});function g(d){if(r[h]=d,o){const[m,p]=V(h);return o[h]=p,t(l[h],m)}return t(l[h])}}}function S(e,t){return ce(()=>e(t||{}))}const xn=e=>`Stale read from <${e}>.`;function bn(e){const t="fallback"in e&&{fallback:()=>e.fallback};return se(wn(()=>e.each,e.children,t||void 0))}function us(e){const t=e.keyed,s=se(()=>e.when,void 0,void 0),n=t?s:se(s,void 0,{equals:(i,r)=>!i==!r});return se(()=>{const i=n();if(i){const r=e.children;return typeof r=="function"&&r.length>0?ce(()=>r(t?i:()=>{if(!ce(n))throw xn("Show");return s()})):r}return e.fallback},void 0,void 0)}function kn(e,t,s){let n=s.length,i=t.length,r=n,a=0,o=0,l=t[i-1].nextSibling,c=null;for(;a<i||o<r;){if(t[a]===s[o]){a++,o++;continue}for(;t[i-1]===s[r-1];)i--,r--;if(i===a){const u=r<n?o?s[o-1].nextSibling:s[r-o]:l;for(;o<r;)e.insertBefore(s[o++],u)}else if(r===o)for(;a<i;)(!c||!c.has(t[a]))&&t[a].remove(),a++;else if(t[a]===s[r-1]&&s[o]===t[i-1]){const u=t[--i].nextSibling;e.insertBefore(s[o++],t[a++].nextSibling),e.insertBefore(s[--r],u),t[i]=s[r]}else{if(!c){c=new Map;let h=o;for(;h<r;)c.set(s[h],h++)}const u=c.get(t[a]);if(u!=null)if(o<u&&u<r){let h=a,g=1,d;for(;++h<i&&h<r&&!((d=c.get(t[h]))==null||d!==u+g);)g++;if(g>u-o){const m=t[a];for(;o<u;)e.insertBefore(s[o++],m)}else e.replaceChild(s[o++],t[a++])}else a++;else t[a++].remove()}}}const hs="_$DX_DELEGATE";function An(e,t,s,n={}){let i;return Qe(r=>{i=r,t===document?e():L(t,e(),t.firstChild?null:void 0,s)},n.owner),()=>{i(),t.textContent=""}}function N(e,t,s,n){let i;const r=()=>{const o=document.createElement("template");return o.innerHTML=e,o.content.firstChild},a=()=>(i||(i=r())).cloneNode(!0);return a.cloneNode=a,a}function ne(e,t=window.document){const s=t[hs]||(t[hs]=new Set);for(let n=0,i=e.length;n<i;n++){const r=e[n];s.has(r)||(s.add(r),t.addEventListener(r,_n))}}function fs(e,t){t==null?e.removeAttribute("class"):e.className=t}function In(e,t,s){return ce(()=>e(t,s))}function L(e,t,s,n){if(s!==void 0&&!n&&(n=[]),typeof t!="function")return st(e,t,n,s);Z(i=>st(e,t(),i,s),n)}function _n(e){let t=e.target;const s=`$$${e.type}`,n=e.target,i=e.currentTarget,r=l=>Object.defineProperty(e,"target",{configurable:!0,value:l}),a=()=>{const l=t[s];if(l&&!t.disabled){const c=t[`${s}Data`];if(c!==void 0?l.call(t,c,e):l.call(t,e),e.cancelBubble)return}return t.host&&typeof t.host!="string"&&!t.host._$host&&t.contains(e.target)&&r(t.host),!0},o=()=>{for(;a()&&(t=t._$host||t.parentNode||t.host););};if(Object.defineProperty(e,"currentTarget",{configurable:!0,get(){return t||document}}),e.composedPath){const l=e.composedPath();r(l[0]);for(let c=0;c<l.length-2&&(t=l[c],!!a());c++){if(t._$host){t=t._$host,o();break}if(t.parentNode===i)break}}else o();r(n)}function st(e,t,s,n,i){for(;typeof s=="function";)s=s();if(t===s)return s;const r=typeof t,a=n!==void 0;if(e=a&&s[0]&&s[0].parentNode||e,r==="string"||r==="number"){if(r==="number"&&(t=t.toString(),t===s))return s;if(a){let o=s[0];o&&o.nodeType===3?o.data!==t&&(o.data=t):o=document.createTextNode(t),s=Me(e,s,n,o)}else s!==""&&typeof s=="string"?s=e.firstChild.data=t:s=e.textContent=t}else if(t==null||r==="boolean")s=Me(e,s,n);else{if(r==="function")return Z(()=>{let o=t();for(;typeof o=="function";)o=o();s=st(e,o,s,n)}),()=>s;if(Array.isArray(t)){const o=[],l=s&&Array.isArray(s);if($t(o,t,s,i))return Z(()=>s=st(e,o,s,n,!0)),()=>s;if(o.length===0){if(s=Me(e,s,n),a)return s}else l?s.length===0?ds(e,o,n):kn(e,s,o):(s&&Me(e),ds(e,o));s=o}else if(t.nodeType){if(Array.isArray(s)){if(a)return s=Me(e,s,n,t);Me(e,s,null,t)}else s==null||s===""||!e.firstChild?e.appendChild(t):e.replaceChild(t,e.firstChild);s=t}}return s}function $t(e,t,s,n){let i=!1;for(let r=0,a=t.length;r<a;r++){let o=t[r],l=s&&s[e.length],c;if(!(o==null||o===!0||o===!1))if((c=typeof o)=="object"&&o.nodeType)e.push(o);else if(Array.isArray(o))i=$t(e,o,l)||i;else if(c==="function")if(n){for(;typeof o=="function";)o=o();i=$t(e,Array.isArray(o)?o:[o],Array.isArray(l)?l:[l])||i}else e.push(o),i=!0;else{const u=String(o);l&&l.nodeType===3&&l.data===u?e.push(l):e.push(document.createTextNode(u))}}return i}function ds(e,t,s=null){for(let n=0,i=t.length;n<i;n++)e.insertBefore(t[n],s)}function Me(e,t,s,n){if(s===void 0)return e.textContent="";const i=n||document.createTextNode("");if(t.length){let r=!1;for(let a=t.length-1;a>=0;a--){const o=t[a];if(i!==o){const l=o.parentNode===e;!r&&!a?l?e.replaceChild(i,o):e.insertBefore(i,s):l&&o.remove()}else r=!0}}else e.insertBefore(i,s);return[i]}const Gt=Symbol("store-raw"),Re=Symbol("store-node"),ue=Symbol("store-has"),ms=Symbol("store-self");function gs(e){let t=e[we];if(!t&&(Object.defineProperty(e,we,{value:t=new Proxy(e,Ln)}),!Array.isArray(e))){const s=Object.keys(e),n=Object.getOwnPropertyDescriptors(e);for(let i=0,r=s.length;i<r;i++){const a=s[i];n[a].get&&Object.defineProperty(e,a,{enumerable:n[a].enumerable,get:n[a].get.bind(t)})}}return t}function nt(e){let t;return e!=null&&typeof e=="object"&&(e[we]||!(t=Object.getPrototypeOf(e))||t===Object.prototype||Array.isArray(e))}function Fe(e,t=new Set){let s,n,i,r;if(s=e!=null&&e[Gt])return s;if(!nt(e)||t.has(e))return e;if(Array.isArray(e)){Object.isFrozen(e)?e=e.slice(0):t.add(e);for(let a=0,o=e.length;a<o;a++)i=e[a],(n=Fe(i,t))!==i&&(e[a]=n)}else{Object.isFrozen(e)?e=Object.assign({},e):t.add(e);const a=Object.keys(e),o=Object.getOwnPropertyDescriptors(e);for(let l=0,c=a.length;l<c;l++)r=a[l],!o[r].get&&(i=e[r],(n=Fe(i,t))!==i&&(e[r]=n))}return e}function it(e,t){let s=e[t];return s||Object.defineProperty(e,t,{value:s=Object.create(null)}),s}function Ce(e,t,s){if(e[t])return e[t];const[n,i]=V(s,{equals:!1,internal:!0});return n.$=i,e[t]=n}function Mn(e,t){const s=Reflect.getOwnPropertyDescriptor(e,t);return!s||s.get||!s.configurable||t===we||t===Re||(delete s.value,delete s.writable,s.get=()=>e[we][t]),s}function ps(e){Ut()&&Ce(it(e,Re),ms)()}function Rn(e){return ps(e),Reflect.ownKeys(e)}const Ln={get(e,t,s){if(t===Gt)return e;if(t===we)return s;if(t===Dt)return ps(e),s;const n=it(e,Re),i=n[t];let r=i?i():e[t];if(t===Re||t===ue||t==="__proto__")return r;if(!i){const a=Object.getOwnPropertyDescriptor(e,t);Ut()&&(typeof r!="function"||e.hasOwnProperty(t))&&!(a&&a.get)&&(r=Ce(n,t,r)())}return nt(r)?gs(r):r},has(e,t){return t===Gt||t===we||t===Dt||t===Re||t===ue||t==="__proto__"?!0:(Ut()&&Ce(it(e,ue),t)(),t in e)},set(){return!0},deleteProperty(){return!0},ownKeys:Rn,getOwnPropertyDescriptor:Mn};function rt(e,t,s,n=!1){if(!n&&e[t]===s)return;const i=e[t],r=e.length;s===void 0?(delete e[t],e[ue]&&e[ue][t]&&i!==void 0&&e[ue][t].$()):(e[t]=s,e[ue]&&e[ue][t]&&i===void 0&&e[ue][t].$());let a=it(e,Re),o;if((o=Ce(a,t,i))&&o.$(()=>s),Array.isArray(e)&&e.length!==r){for(let l=e.length;l<r;l++)(o=a[l])&&o.$();(o=Ce(a,"length",r))&&o.$(e.length)}(o=a[ms])&&o.$()}function Es(e,t){const s=Object.keys(t);for(let n=0;n<s.length;n+=1){const i=s[n];rt(e,i,t[i])}}function Pn(e,t){if(typeof t=="function"&&(t=t(e)),t=Fe(t),Array.isArray(t)){if(e===t)return;let s=0,n=t.length;for(;s<n;s++){const i=t[s];e[s]!==i&&rt(e,s,i)}rt(e,"length",n)}else Es(e,t)}function $e(e,t,s=[]){let n,i=e;if(t.length>1){n=t.shift();const a=typeof n,o=Array.isArray(e);if(Array.isArray(n)){for(let l=0;l<n.length;l++)$e(e,[n[l]].concat(t),s);return}else if(o&&a==="function"){for(let l=0;l<e.length;l++)n(e[l],l)&&$e(e,[l].concat(t),s);return}else if(o&&a==="object"){const{from:l=0,to:c=e.length-1,by:u=1}=n;for(let h=l;h<=c;h+=u)$e(e,[h].concat(t),s);return}else if(t.length>1){$e(e[n],t,[n].concat(s));return}i=e[n],s=[n].concat(s)}let r=t[0];typeof r=="function"&&(r=r(i,s),r===i)||n===void 0&&r==null||(r=Fe(r),n===void 0||nt(i)&&nt(r)&&!Array.isArray(r)?Es(i,r):rt(e,n,r))}function Ht(...[e,t]){const s=Fe(e||{}),n=Array.isArray(s),i=gs(s);function r(...a){hn(()=>{n&&a.length===1?Pn(s,a[0]):$e(s,a)})}return[i,r]}var Sn=N('<div class=hlv-loading><div class=hlv-loading-spinner><svg xmlns=http://www.w3.org/2000/svg x=0px y=0px width=80px height=80px viewBox="0 0 80 80"><title>Loading</title><path fill=#ffffff d=M40,72C22.4,72,8,57.6,8,40C8,22.4,22.4,8,40,8c17.6,0,32,14.4,32,32c0,1.1-0.9,2-2,2s-2-0.9-2-2c0-15.4-12.6-28-28-28S12,24.6,12,40s12.6,28,28,28c1.1,0,2,0.9,2,2S41.1,72,40,72z></path></svg></div><div class=hlv-loading-log>'),Nn=N("<div class=hlv-loading-log-item>");const On={replay:"Replay",bsp:"Map",sound:"Sounds",sky:"Skybox",sprite:"Sprites",wad:"Wads"};function Dn(e){const[t,s]=Ht({});De(()=>{const a=e.game.loader.events,o=a.on("loadstart",n),l=a.on("progress",i);Ie(()=>{o==null||o(),l==null||l()})});const n=a=>{const o=t[a.type]?t[a.type]:[];for(let l=0;l<o.length;++l)if(o[l]===a)return;o.push({name:a.name,progress:0}),s(a.type,o)},i=a=>{if(!t[a.type])return;const o=t[a.type];for(let l=0;l<o.length;++l)if(o[l].name===a.name){s(a.type,l,{progress:a.progress});break}},r=(a,o)=>{let l=a;l=On[l];const c=`${Math.round(o*100)}%`;let u=29-l.length-c.length;u<2&&(u=9-c.length);const h=Array(u).join(".");return`${l}${h}${c}`};return(()=>{var a=Sn(),o=a.firstChild,l=o.nextSibling;return L(l,S(bn,{get each(){return Object.entries(t)},children:([c,u])=>(()=>{var h=Nn();return L(h,()=>r(c,u.reduce((g,d)=>g+d.progress,0)/u.length)),h})()})),Z(()=>a.classList.toggle("visible",!!e.visible)),a})()}var Bn=N('<div class=hlv-settings><button type=button class=hlv-button><svg xmlns=http://www.w3.org/2000/svg width=24 height=24 viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=2 stroke-linecap=round stroke-linejoin=round><title>Toggle</title><path stroke=none d="M0 0h24v24H0z"fill=none></path><path d="M10.325 4.317c.426 -1.756 2.924 -1.756 3.35 0a1.724 1.724 0 0 0 2.573 1.066c1.543 -.94 3.31 .826 2.37 2.37a1.724 1.724 0 0 0 1.065 2.572c1.756 .426 1.756 2.924 0 3.35a1.724 1.724 0 0 0 -1.066 2.573c.94 1.543 -.826 3.31 -2.37 2.37a1.724 1.724 0 0 0 -2.572 1.065c-.426 1.756 -2.924 1.756 -3.35 0a1.724 1.724 0 0 0 -2.573 -1.066c-1.543 .94 -3.31 -.826 -2.37 -2.37a1.724 1.724 0 0 0 -1.065 -2.572c-1.756 -.426 -1.756 -2.924 0 -3.35a1.724 1.724 0 0 0 1.066 -2.573c-.94 -1.543 .826 -3.31 2.37 -2.37c1 .608 2.296 .07 2.572 -1.065z"></path><path d="M9 12a3 3 0 1 0 6 0a3 3 0 0 0 -6 0"></path></svg></button><div class=hlv-settings-menu><span class=hlv-settings-menu-title>Mode</span><button type=button class=hlv-settings-menu-item>Free Move</button><span class=hlv-settings-menu-title>Display</span><button type=button class=hlv-settings-menu-item>Show keys'),Un=N("<button type=button class=hlv-settings-menu-item>Replay"),Fn=N("<span>");function Ts(e){const[t,s]=V(!1),n=!!e.game.player.replay,i=()=>{e.game.mode!==W.FREE&&(e.game.changeMode(W.FREE),e.game.player.pause())},r=()=>{e.game.mode!==W.REPLAY&&e.game.changeMode(W.REPLAY)},a=()=>{e.game.changeShowKeys()};return(()=>{var o=Bn(),l=o.firstChild,c=l.nextSibling,u=c.firstChild,h=u.nextSibling,g=h.nextSibling,d=g.nextSibling;return l.$$click=()=>s(!t()),L(c,n?(()=>{var m=Un();return m.$$click=()=>r(),Z(()=>m.classList.toggle("selected",e.game.mode===W.REPLAY)),m})():Fn(),h),h.$$click=()=>i(),d.$$click=()=>a(),Z(m=>{var p=!!t(),E=e.game.mode===W.FREE,v=!!e.game.showKeys;return p!==m.e&&o.classList.toggle("open",m.e=p),E!==m.t&&h.classList.toggle("selected",m.t=E),v!==m.a&&d.classList.toggle("selected",m.a=v),m},{e:void 0,t:void 0,a:void 0}),o})()}ne(["click"]);const he=[{enabled:"fullscreenEnabled",element:"fullscreenElement",request:"requestFullscreen",exit:"exitFullscreen",change:"fullscreenchange",error:"fullscreenerror"},{enabled:"mozFullScreenEnabled",element:"mozFullScreenElement",request:"mozRequestFullScreen",exit:"mozCancelFullScreen",change:"mozfullscreenchange",error:"mozfullscreenerror"},{enabled:"webkitFullscreenEnabled",element:"webkitCurrentFullScreenElement",request:"webkitRequestFullscreen",exit:"webkitExitFullscreen",change:"webkitfullscreenchange",error:"webkitfullscreenerror"},{enabled:"msFullscreenEnabled",element:"msFullscreenElement",request:"msRequestFullscreen",exit:"msExitFullscreen",change:"MSFullscreenChange",error:"MSFullscreenError"}];let Ee=0;const ot=document;for(let e=0;e<he.length;++e)if(typeof ot[he[e].enabled]<"u"){Ee=e;break}const z={element(){return ot[he[Ee].element]},enabled(){return ot[he[Ee].enabled]},isInFullscreen(){return z.element()!==null},enter(e){e[he[Ee].request]()},exit(){ot[he[Ee].exit]()},onChange(e){return window.addEventListener(he[Ee].change,e)},onChangeRemove(e){window.removeEventListener(he[Ee].change,e)},onError(e){return window.addEventListener(he[Ee].error,e)}};var Cn=N('<button type=button class="hlv-button hlv-fullscreen-button">'),$n=N('<svg xmlns=http://www.w3.org/2000/svg width=24 height=24 viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=2 stroke-linecap=round stroke-linejoin=round class="icon icon-tabler icons-tabler-outline icon-tabler-minimize"><title>Exit fullscreen</title><path stroke=none d="M0 0h24v24H0z"fill=none></path><path d="M15 19v-2a2 2 0 0 1 2 -2h2"></path><path d="M15 5v2a2 2 0 0 0 2 2h2"></path><path d="M5 15h2a2 2 0 0 1 2 2v2"></path><path d="M5 9h2a2 2 0 0 0 2 -2v-2">'),Gn=N('<svg xmlns=http://www.w3.org/2000/svg width=24 height=24 viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=2 stroke-linecap=round stroke-linejoin=round><title>Fullscreen</title><path stroke=none d="M0 0h24v24H0z"fill=none></path><path d="M4 8v-2a2 2 0 0 1 2 -2h2"></path><path d="M4 16v2a2 2 0 0 0 2 2h2"></path><path d="M16 4h2a2 2 0 0 1 2 2v2"></path><path d="M16 20h2a2 2 0 0 0 2 -2v-2">');function vs(e){const[t,s]=V(z.isInFullscreen());De(()=>{z.onChange(i)}),Ie(()=>{z.onChangeRemove(i)});const n=()=>{z.isInFullscreen()?z.exit():z.enter(e.root)},i=()=>{s(z.isInFullscreen())};return(()=>{var r=Cn();return r.$$click=()=>n(),L(r,(()=>{var a=se(()=>!!t());return()=>a()?$n():Gn()})()),r})()}ne(["click"]);var Hn=N("<div><div class=hlv-buttons><div class=hlv-buttons-left></div><div class=hlv-buttons-right>");function Xn(e){return(()=>{var t=Hn(),s=t.firstChild,n=s.firstChild,i=n.nextSibling;return L(i,S(Ts,{get game(){return e.game}}),null),L(i,S(vs,{active:!1,get root(){return e.root}}),null),Z(()=>fs(t,e.class)),t})()}const ys=fn({mode:W.FREE,time:0,volume:1,isPlaying:!1,isPaused:!1});function at(){return dn(ys)}var jn=N("<div class=hlv-time> / ");function Wn(e){const t=at(),s=()=>pt(t.time),n=()=>pt(e.player.replay.length);return(()=>{var i=jn(),r=i.firstChild;return L(i,s,r),L(i,n,null),i})()}var zn=N("<button type=button class=hlv-timeline><div class=hlv-timeline-ghostline></div><div class=hlv-timeline-line></div><div class=hlv-timeline-knob></div><div class=hlv-timeline-ghosttime>");function qn(e){const[t,s]=V(0),[n,i]=V(!1),[r,a]=V("0%"),[o,l]=V(0);De(()=>{const p=e.game.events.on("postupdate",()=>{s(e.game.player.currentTime/e.game.player.replay.length)});Ie(()=>{p==null||p()})});const c=p=>{const E=p.currentTarget.getClientRects()[0],v=1-(E.right-p.pageX)/(E.right-E.left);e.game.player.seekByPercent(v*100),e.game.player.pause();const y=x=>{const w=Math.max(0,Math.min(1-(E.right-x.pageX)/(E.right-E.left),1));e.game.player.seekByPercent(w*100),e.game.player.pause()};window.addEventListener("mousemove",y),window.addEventListener("mouseup",()=>{window.removeEventListener("mousemove",y)},{once:!0})},u=p=>{const E=p.currentTarget.getClientRects()[0],v=Math.max(0,Math.min(1-(E.right-p.pageX)/(E.right-E.left),1));n()&&(a(`${v*100}%`),l(e.game.player.replay.length*v))},h=()=>{i(!0)},g=()=>{i(!1)},d=()=>`${t()*100}%`,m=()=>`${100-t()*100}%`;return(()=>{var p=zn(),E=p.firstChild,v=E.nextSibling,y=v.nextSibling,x=y.nextSibling;return p.addEventListener("mouseleave",()=>g()),p.addEventListener("mouseenter",()=>h()),p.$$mousemove=w=>u(w),p.$$mousedown=w=>c(w),L(x,()=>pt(o())),Z(w=>{var M=m(),C=d(),I=r();return M!==w.e&&((w.e=M)!=null?v.style.setProperty("right",M):v.style.removeProperty("right")),C!==w.t&&((w.t=C)!=null?y.style.setProperty("left",C):y.style.removeProperty("left")),I!==w.a&&((w.a=I)!=null?x.style.setProperty("left",I):x.style.removeProperty("left")),w},{e:void 0,t:void 0,a:void 0}),p})()}ne(["mousedown","mousemove"]);var Vn=N("<div class=hlv-volume><div class=hlv-volume-ghostline></div><div class=hlv-volume-line></div><div class=hlv-volume-knob>");function Zn(e){const t=at(),s=a=>{const o=a.currentTarget.getClientRects()[0],l=1-(o.right-a.pageX)/(o.right-o.left);e.game.soundSystem.setVolume(l);const c=u=>{const h=Math.max(0,Math.min(1-(o.right-u.pageX)/(o.right-o.left),1));e.game.soundSystem.setVolume(h)};window.addEventListener("mousemove",c),window.addEventListener("mouseup",()=>{window.removeEventListener("mousemove",c)},{once:!0})},n=()=>t.volume*100,i=()=>`${Math.min(95,Math.max(5,n()))}%`,r=()=>`${Math.min(95,Math.max(5,100-n()))}%`;return(()=>{var a=Vn(),o=a.firstChild,l=o.nextSibling,c=l.nextSibling;return a.$$mousedown=u=>s(u),Z(u=>{var h=r(),g=i();return h!==u.e&&((u.e=h)!=null?l.style.setProperty("right",h):l.style.removeProperty("right")),g!==u.t&&((u.t=g)!=null?c.style.setProperty("left",g):c.style.removeProperty("left")),u},{e:void 0,t:void 0}),a})()}ne(["mousedown"]);var Kn=N('<button type=button class=hlv-button><svg xmlns=http://www.w3.org/2000/svg width=24 height=24 viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=2 stroke-linecap=round stroke-linejoin=round><title>Play</title><path stroke=none d="M0 0h24v24H0z"fill=none></path><path d="M7 4v16l13 -8z">');function Yn(e){return(()=>{var t=Kn();return t.$$click=()=>e.onClick(),t})()}ne(["click"]);var Jn=N('<button type=button class=hlv-button><svg xmlns=http://www.w3.org/2000/svg width=24 height=24 viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=2 stroke-linecap=round stroke-linejoin=round><title>Pause</title><path stroke=none d="M0 0h24v24H0z"fill=none></path><path d="M6 5m0 1a1 1 0 0 1 1 -1h2a1 1 0 0 1 1 1v12a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1z"></path><path d="M14 5m0 1a1 1 0 0 1 1 -1h2a1 1 0 0 1 1 1v12a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1z">');function Qn(e){return(()=>{var t=Jn();return t.$$click=()=>e.onClick(),t})()}ne(["click"]);var ei=N('<svg xmlns=http://www.w3.org/2000/svg width=24 height=24 viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=2 stroke-linecap=round stroke-linejoin=round><title>Volume Full</title><path stroke=none d="M0 0h24v24H0z"fill=none></path><path d="M15 8a5 5 0 0 1 0 8"></path><path d="M17.7 5a9 9 0 0 1 0 14"></path><path d="M6 15h-2a1 1 0 0 1 -1 -1v-4a1 1 0 0 1 1 -1h2l3.5 -4.5a.8 .8 0 0 1 1.5 .5v14a.8 .8 0 0 1 -1.5 .5l-3.5 -4.5">');function ti(){return ei()}var si=N('<svg xmlns=http://www.w3.org/2000/svg width=24 height=24 viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=2 stroke-linecap=round stroke-linejoin=round class="icon icon-tabler icons-tabler-outline icon-tabler-volume-2"><title>Volume Half</title><path stroke=none d="M0 0h24v24H0z"fill=none></path><path d="M15 8a5 5 0 0 1 0 8"></path><path d="M6 15h-2a1 1 0 0 1 -1 -1v-4a1 1 0 0 1 1 -1h2l3.5 -4.5a.8 .8 0 0 1 1.5 .5v14a.8 .8 0 0 1 -1.5 .5l-3.5 -4.5">');function ni(){return si()}var ii=N('<svg xmlns=http://www.w3.org/2000/svg width=24 height=24 viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=2 stroke-linecap=round stroke-linejoin=round class="icon icon-tabler icons-tabler-outline icon-tabler-volume-3"><title>Volume Mute</title><path stroke=none d="M0 0h24v24H0z"fill=none></path><path d="M6 15h-2a1 1 0 0 1 -1 -1v-4a1 1 0 0 1 1 -1h2l3.5 -4.5a.8 .8 0 0 1 1.5 .5v14a.8 .8 0 0 1 -1.5 .5l-3.5 -4.5"></path><path d="M16 10l4 4m0 -4l-4 4">');function ri(){return ii()}var oi=N("<button type=button class=hlv-button>");function ai(e){const t=at();return(()=>{var s=oi();return s.$$click=()=>e.onClick(),L(s,(()=>{var n=se(()=>t.volume===0);return()=>n()?S(ri,{}):se(()=>t.volume>.5)()?S(ti,{}):S(ni,{})})()),s})()}ne(["click"]);var li=N('<button type=button class=hlv-button><svg xmlns=http://www.w3.org/2000/svg width=24 height=24 viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=2 stroke-linecap=round stroke-linejoin=round><title>Speed Up</title><path stroke=none d="M0 0h24v24H0z"fill=none></path><path d="M3 5v14l8 -7z"></path><path d="M14 5v14l8 -7z">');function ci(e){return(()=>{var t=li();return t.$$click=()=>e.onClick(),t})()}ne(["click"]);var ui=N('<button type=button class=hlv-button><svg xmlns=http://www.w3.org/2000/svg width=24 height=24 viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=2 stroke-linecap=round stroke-linejoin=round><title>Speed Down</title><path stroke=none d="M0 0h24v24H0z"fill=none></path><path d="M21 5v14l-8 -7z"></path><path d="M10 5v14l-8 -7z">');function hi(e){return(()=>{var t=ui();return t.$$click=()=>e.onClick(),t})()}ne(["click"]);var fi=N("<div><div class=hlv-buttons><div class=hlv-buttons-left><div></div><div></div></div><div class=hlv-buttons-right>");function di(e){const t=at(),s=()=>{e.game.player.play()},n=()=>{e.game.player.pause()},i=()=>{e.game.player.speedDown()},r=()=>{e.game.player.speedUp()},a=()=>{e.game.soundSystem.toggleMute()};return(()=>{var o=fi(),l=o.firstChild,c=l.firstChild,u=c.firstChild;u.nextSibling;var h=c.nextSibling;return L(o,S(qn,{get game(){return e.game}}),l),L(c,S(hi,{onClick:()=>i()}),u),L(c,(()=>{var g=se(()=>!!(t.isPaused||!t.isPlaying));return()=>g()?S(Yn,{onClick:()=>s()}):S(Qn,{onClick:()=>n()})})(),u),L(c,S(ci,{onClick:()=>r()}),u),L(c,S(ai,{onClick:()=>a()}),null),L(c,S(Zn,{get game(){return e.game}}),null),L(c,S(Wn,{get player(){return e.game.player}}),null),L(h,S(Ts,{get game(){return e.game}}),null),L(h,S(vs,{active:!0,get root(){return e.root}}),null),Z(()=>fs(o,e.class)),o})()}var mi=N('<div class=hlv-keys-hud><div class=hlv-keyboard><div class="hlv-key hlv-key-w">W</div><div class="hlv-key hlv-key-a">A</div><div class="hlv-key hlv-key-s">S</div><div class="hlv-key hlv-key-d">D</div><div class="hlv-key hlv-key-duck">DUCK</div><div class="hlv-key hlv-key-jump">JUMP</div><div class="hlv-key hlv-key-use">USE');function gi(e){const[t,s]=Ht({jump:!1,duck:!1,forward:!1,back:!1,use:!1,moveleft:!1,moveright:!1});De(()=>{const r=e.game.player.events.on("keyspressed",n);Ie(()=>{r==null||r()})});const n=i=>{s("jump",(i&j.BTN_JUMP)!=0),s("duck",(i&j.BTN_DUCK)!=0),s("use",(i&j.BTN_USE)!=0);const r=(i&j.BTN_FORWARD)!=0,a=(i&j.BTN_BACK)!=0,o=(i&j.BTN_MOVELEFT)!=0,l=(i&j.BTN_MOVERIGHT)!=0;s("forward",r&&!a),s("back",a&&!r),s("moveleft",o&&!l),s("moveright",l&&!o)};return(()=>{var i=mi(),r=i.firstChild,a=r.firstChild,o=a.nextSibling,l=o.nextSibling,c=l.nextSibling,u=c.nextSibling,h=u.nextSibling,g=h.nextSibling;return Z(d=>{var m=!!e.visible,p=!!t.forward,E=!!t.moveleft,v=!!t.back,y=!!t.moveright,x=!!t.duck,w=!!t.jump,M=!!t.use;return m!==d.e&&i.classList.toggle("visible",d.e=m),p!==d.t&&a.classList.toggle("activated",d.t=p),E!==d.a&&o.classList.toggle("activated",d.a=E),v!==d.o&&l.classList.toggle("activated",d.o=v),y!==d.i&&c.classList.toggle("activated",d.i=y),x!==d.n&&u.classList.toggle("activated",d.n=x),w!==d.s&&h.classList.toggle("activated",d.s=w),M!==d.h&&g.classList.toggle("activated",d.h=M),d},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0,n:void 0,s:void 0,h:void 0}),i})()}var pi=N("<div class=hlv-app><div class=hlv-title></div><button type=button class=hlv-screen>");function Ei(e){let t=null,s;const[n,i]=V(e.game.title),[r,a]=V(!1),[o,l]=V(!1),[c,u]=V(!1),[h,g]=V(!1),[d,m]=Ht({mode:e.game.mode,time:e.game.player.currentTime,volume:e.game.soundSystem.getVolume(),isPlaying:e.game.player.isPlaying,isPaused:e.game.player.isPaused,showKeys:e.game.showKeys});De(()=>{if(!t)return;const A=e.game,F=e.root;t.appendChild(A.getCanvas());const q=A.events.on("loadstart",()=>l(!0)),$=A.events.on("load",()=>l(!1)),_=A.events.on("modechange",ve=>m({mode:ve})),U=A.events.on("titlechange",ve=>i(ve)),ee=e.game.player.events.on("play",()=>m({isPlaying:!0,isPaused:!1})),lt=e.game.player.events.on("pause",()=>m({isPlaying:!0,isPaused:!0})),ct=e.game.player.events.on("stop",()=>m({isPlaying:!1,isPaused:!1})),ut=e.game.soundSystem.events.on("volumeChange",()=>{m({volume:e.game.soundSystem.getVolume()})}),ht=A.events.on("showkeyschange",ve=>m({showKeys:ve}));let Xt;const xs=()=>{Xt=setInterval(()=>{m({time:e.game.player.currentTime})},100)},jt=()=>{clearInterval(Xt)},ft=e.game.player.events.on("play",xs),dt=e.game.player.events.on("pause",jt),mt=e.game.player.events.on("stop",jt),gt=e.game.player.events.on("seek",ve=>m({time:ve}));window.addEventListener("click",v),window.addEventListener("keydown",x),document.addEventListener("pointerlockchange",p,!1),F.addEventListener("click",y),F.addEventListener("mouseover",w),F.addEventListener("mousemove",M),F.addEventListener("mouseout",C),F.addEventListener("contextmenu",E),Ie(()=>{q==null||q(),$==null||$(),_==null||_(),U==null||U(),ee==null||ee(),lt==null||lt(),ct==null||ct(),ut==null||ut(),ht==null||ht(),ft==null||ft(),dt==null||dt(),mt==null||mt(),gt==null||gt(),e.root.removeEventListener("click",y),window.removeEventListener("click",v),window.removeEventListener("keydown",x),document.removeEventListener("pointerlockchange",p,!1),e.root.removeEventListener("mouseover",w),e.root.removeEventListener("mousemove",M),e.root.removeEventListener("mouseout",C),e.root.removeEventListener("contextmenu",E)})});const p=()=>{document.pointerLockElement===e.root?e.game.pointerLocked=!0:e.game.pointerLocked=!1},E=A=>{A.preventDefault()},v=A=>{A.target.closest(".hlv-app")||a(!1)},y=()=>{a(!0),I()},x=A=>{if(r())switch(A.code){case"KeyF":{z.isInFullscreen()?z.exit():z.enter(e.root),I();break}case"KeyM":{e.game.soundSystem.toggleMute(),I();break}case"ArrowUp":{e.game.soundSystem.setVolume(e.game.soundSystem.getVolume()+.05),I();break}case"ArrowDown":{e.game.soundSystem.setVolume(e.game.soundSystem.getVolume()-.05),I();break}case"KeyJ":case"ArrowLeft":{e.game.player.seek(e.game.player.currentTime-5),I();break}case"KeyL":case"ArrowRight":{e.game.player.seek(e.game.player.currentTime+5),I();break}case"KeyK":case"Space":{if(d.mode!==W.REPLAY)return;!e.game.player.isPlaying||e.game.player.isPaused?e.game.player.play():e.game.player.pause();break}}},w=()=>{u(!0),I()},M=()=>{c()&&!z.isInFullscreen()&&I()},C=()=>{u(!1),g(!1),clearTimeout(s),s=void 0},I=()=>{h()||g(!0),clearTimeout(s),s=setTimeout(()=>{g(!1),s=void 0},2e3)},b=()=>{switch(d.mode){case W.REPLAY:{const A=e.game.player;!A.isPlaying||A.isPaused?A.play():A.pause();break}case W.FREE:{e.root.requestPointerLock();break}}},k=()=>{z.isInFullscreen()?z.exit():z.enter(e.root)};return S(ys.Provider,{value:d,get children(){var A=pi(),F=A.firstChild,q=F.nextSibling;return L(F,n),L(A,S(Dn,{get game(){return e.game},get visible(){return o()}}),q),L(A,S(gi,{get game(){return e.game},get visible(){return d.showKeys&&d.isPlaying}}),q),q.$$dblclick=()=>k(),q.$$click=()=>b(),In($=>{t=$},q),L(A,S(us,{get when(){return d.mode===W.FREE},get children(){return S(Xn,{class:"hlv-controls",get game(){return e.game},get root(){return e.root}})}}),null),L(A,S(us,{get when(){return d.mode===W.REPLAY},get children(){return S(di,{class:"hlv-controls",get game(){return e.game},get root(){return e.root},get visible(){return c()}})}}),null),Z($=>{var _=!!h(),U=d.mode===W.FREE,ee=d.mode===W.REPLAY;return _!==$.e&&A.classList.toggle("visible",$.e=_),U!==$.t&&A.classList.toggle("mode-free",$.t=U),ee!==$.a&&A.classList.toggle("mode-replay",$.a=ee),$},{e:void 0,t:void 0,a:void 0}),A}})}ne(["click","dblclick"]);class Ti{constructor(t,s){f(this,"game");f(this,"rootNode");this.game=t,this.rootNode=s}getRootNode(){return this.rootNode}draw(){An(()=>{const t=this;return S(Ei,{get game(){return t.game},get root(){return t.rootNode}})},this.rootNode)}}class ws{constructor(t){f(this,"game");this.game=t}load(t){this.game.load(t)}setTitle(t){this.game.setTitle(t)}getTitle(){return this.game.getTitle()}}f(ws,"VERSION","0.8.3"),X.HLViewer=void 0,(e=>{function t(s,n){const i=document.querySelector(s);if(!i)return null;const r=Ze.init(n),a=Ot.init(r);if(a.status==="success"){const o=a.game;return new Ti(o,i).draw(),o.draw(),new ws(o)}return null}e.init=t})(X.HLViewer||(X.HLViewer={})),typeof window<"u"&&Object.assign(window,{HLViewer:X.HLViewer}),Object.defineProperty(X,Symbol.toStringTag,{value:"Module"})});
